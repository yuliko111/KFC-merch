!function (a) {
    "object" == typeof module && module.exports ? module.exports = a() : window.intlTelInputAG = a()
}(function (a) {
    "use strict";
    return function () {
        function b(a, b) {
        ...
        var l = function (a, b) {
            ...
            return d(c, [{
                key: "_init", value: function () {
                    ...
                    console.log("_init");
                    console.log(this.d);
                    if (this.d.nationalMode && (this.d.autoHideDialCode = !1), this.d.separateDialCode && (this.d.autoHideDialCode = this.d.nationalMode = !1), this.g = /Android.+Mobile|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), this.g && false && (document.body.classList.add("iti-mobile"), this.d.dropdownContainer || (this.d.dropdownContainer = document.body)), "undefined" != typeof Promise) {
                ...
                key: "_f", value: function () {
                    ...
                    if (this.a.parentNode.insertBefore(b, this.a), this.k = this._e2("div", {"class": "iti__flag-container"}, b), b.appendChild(this.a), this.selectedFlag = this._e2("div", {
                        ...
                        id: "country-listbox",
                        role: "listbox"
                    }), console.log(this.d), console.log(this.k), console.log(this.m), this.preferredCountries.length && (this._g(this.preferredCountries, "iti__preferred"), this._e2("li", {
                        "class": "iti__divider",
                        role: "separator",
                        "aria-disabled": "true"
                ...
                key: "_j", value: function () {
                    var a = this;
                    this._a12 = function () {/* a._v(a.a.value)&&a._8() */
        ...
        return h.loadUtils = function (a) {
            ...
            return null
        }, h.defaults = j, h.version = "16.1.0", function (a, b) {
            var c = new n(a, b);
