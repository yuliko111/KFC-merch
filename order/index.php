...
?>
	<form action="/merch/order/" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		<input type="hidden" name="sessid" id="sessid" value="38994574e713f469abb400fa31fbcdd3"> <input type="hidden"
																										name="soa-action"
																										value="saveOrderAjax">
				...
				<div class="checkout">
					<div class="checkout-left"><!----> <!----> <!---->
						<div class="checkout-left-phone-bonus">
							...
							<div class="checkout-left-phone-bonus-input">
								...
								<input type="range" name="BONUSES" min="0" max="116"
									   class="checkout-left-phone-bonus-input-el"></div>
						</div> <!---->
						<div data-code="0" class="checkout-left-grid">
							<div class="k-input-wrapper"><input placeholder="Имя*" name="ORDER_PROP_1" class="k-input">
							</div>
							<div class="k-input-wrapper"><input placeholder="Фамилия*" name="ORDER_PROP_2"
																class="k-input"></div>
						</div>
								...
								<div class="iti iti--allow-dropdown iti--separate-dial-code ag-countrymask">
									<div class="iti__flag-container">
										<div class="iti__selected-flag" role="combobox" aria-owns="country-listbox"
											 aria-expanded="false" tabindex="0" title="Россия: +7"
											 aria-activedescendant="iti-item-ru">
											<div class="iti__flag iti__ru"></div>
											<div class="iti__selected-dial-code">+7</div>
											<div class="iti__arrow"></div>
										</div>
										<ul class="iti__country-list iti__hide" id="country-listbox" role="listbox">
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-az"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-am"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-by"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-kz"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-kg"
											...
											<li class="iti__country iti__preferred iti__active" tabindex="-1"
												id="iti-item-ru" role="option" data-dial-code="7" data-country-code="ru"
												aria-selected="true">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ru"></div>
												</div>
												<span class="iti__country-name">Россия</span><span
													class="iti__dial-code">+7</span></li>
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-rs"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-tm"
											...
											<li class="iti__country iti__preferred" tabindex="-1" id="iti-item-uz"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-as"
												role="option" data-dial-code="1" data-country-code="as">
												<div class="iti__flag-box">
													<div class="iti__flag iti__as"></div>
												</div>
												<span class="iti__country-name">Американское Самоа</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ag"
												...
												<span class="iti__country-name">Антигуа и Барбуда</span><span
													class="iti__dial-code">+1</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-af"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bs"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-by"
												role="option" data-dial-code="375" data-country-code="by">
												<div class="iti__flag-box">
													<div class="iti__flag iti__by"></div>
												</div>
												<span class="iti__country-name">Беларусь</span><span
													class="iti__dial-code">+375</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bz"
												...
												<span class="iti__country-name">Белиз</span><span
													class="iti__dial-code">+501</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bo"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bq"
												role="option" data-dial-code="599" data-country-code="bq">
												<div class="iti__flag-box">
													<div class="iti__flag iti__bq"></div>
												</div>
												<span class="iti__country-name">Бонэйр, Синт-Эстатиус и Саба</span><span
													class="iti__dial-code">+599</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ba"
												role="option" data-dial-code="387" data-country-code="ba">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ba"></div>
												</div>
												<span class="iti__country-name">Босния и Герцеговина</span><span
													class="iti__dial-code">+387</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bw"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-io"
												role="option" data-dial-code="246" data-country-code="io">
												<div class="iti__flag-box">
													<div class="iti__flag iti__io"></div>
												</div>
												<span
													class="iti__country-name">Британская территория в Индийском океане</span><span
													class="iti__dial-code">+246</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bn"
												role="option" data-dial-code="673" data-country-code="bn">
												<div class="iti__flag-box">
													<div class="iti__flag iti__bn"></div>
												</div>
												<span class="iti__country-name">Бруней-Даруссалам</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bi"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-vu"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ve"
												role="option" data-dial-code="58" data-country-code="ve">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ve"></div>
												</div>
												<span
													class="iti__country-name">Венесуэла (Боливарианская Республика)</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-vg"
												...
												<span class="iti__country-name">Виргинские Острова</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-vi"
												role="option" data-dial-code="1" data-country-code="vi">
												<div class="iti__flag-box">
													<div class="iti__flag iti__vi"></div>
												</div>
												<span class="iti__country-name">Виргинские Острова (США)</span><span
													class="iti__dial-code">+1</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gh"
												...
												<span class="iti__country-name">Гана</span><span class="iti__dial-code">+233</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gw"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-hn"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gu"
												...
												<span class="iti__country-name">Гуам</span><span class="iti__dial-code">+1</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-dm"
												...
												<span class="iti__country-name">Доминика</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-do"
												role="option" data-dial-code="1" data-country-code="do">
												<div class="iti__flag-box">
													<div class="iti__flag iti__do"></div>
												</div>
												<span class="iti__country-name">Доминиканская Республика</span><span
													class="iti__dial-code">+1</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-eh"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-zw"
												role="option" data-dial-code="263" data-country-code="zw">
												<div class="iti__flag-box">
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-iq"
												role="option" data-dial-code="964" data-country-code="iq">
												<div class="iti__flag-box">
													<div class="iti__flag iti__iq"></div>
												</div>
												<span class="iti__country-name">Ирак</span><span class="iti__dial-code">+964</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ir"
												role="option" data-dial-code="98" data-country-code="ir">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ir"></div>
												</div>
												<span class="iti__country-name">Иран</span><span class="iti__dial-code">+98</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ye"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cv"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kz"
												...
												<span class="iti__country-name">Казахстан</span><span
													class="iti__dial-code">+7</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kh"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ke"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cy"
												...
												<span class="iti__country-name">Кипр</span><span class="iti__dial-code">+357</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kg"
												...
												<span class="iti__country-name">Киргизия</span><span
													class="iti__dial-code">+996</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ki"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cc"
												role="option" data-dial-code="61" data-country-code="cc">
												<div class="iti__flag-box">
													<div class="iti__flag iti__cc"></div>
												</div>
												<span class="iti__country-name">Кокосовые (Килинг) острова</span><span
													class="iti__dial-code">+61</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cg"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cd"
												role="option" data-dial-code="243" data-country-code="cd">
												<div class="iti__flag-box">
													<div class="iti__flag iti__cd"></div>
												</div>
												<span class="iti__country-name">Конго, Демократическая Республика</span><span
													class="iti__dial-code">+243</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kp"
												role="option" data-dial-code="850" data-country-code="kp">
												<div class="iti__flag-box">
													<div class="iti__flag iti__kp"></div>
												</div>
												<span class="iti__country-name">Корея, Народно-Демократическая Республика</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kr"
												...
												<span class="iti__country-name">Корея, Республика</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ci"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cu"
												role="option" data-dial-code="53" data-country-code="cu">
												<div class="iti__flag-box">
													<div class="iti__flag iti__cu"></div>
												</div>
												<span class="iti__country-name">Куба</span><span class="iti__dial-code">+53</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kw"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cw"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-la"
												...
												<span class="iti__country-name">Лаосская Народно-Демократическая Республика</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-lr"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ly"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mu"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mr"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ml"
												role="option" data-dial-code="223" data-country-code="ml">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ml"></div>
												</div>
												<span class="iti__country-name">Мали</span><span class="iti__dial-code">+223</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ma"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mh"
												...
												<span class="iti__country-name">Маршалловы Острова</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-fm"
												role="option" data-dial-code="691" data-country-code="fm">
												<div class="iti__flag-box">
													<div class="iti__flag iti__fm"></div>
												</div>
												<span
													class="iti__country-name">Микронезия, Федеративные Штаты</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-md"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mn"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ms"
												...
												<span class="iti__country-name">Монтсеррат</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mm"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-nr"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-nu"
												role="option" data-dial-code="683" data-country-code="nu">
												<div class="iti__flag-box">
													<div class="iti__flag iti__nu"></div>
												</div>
												<span class="iti__country-name">Ниуэ</span><span class="iti__dial-code">+683</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ae"
												...
												<span
													class="iti__country-name">Объединенные Арабские Эмираты</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-om"
												...
												<span class="iti__country-name">Оман</span><span class="iti__dial-code">+968</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-im"
												...
												<span class="iti__country-name">Остров Мэн</span><span
													class="iti__dial-code">+44</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-nf"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ky"
												...
												<span class="iti__country-name">Острова Кайман</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ck"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tc"
												...
												<span class="iti__country-name">Острова Теркс и Кайкос</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pk"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ps"
												...
												<span class="iti__country-name">Палестина, Государство</span><span
													class="iti__dial-code">+970</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pa"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-va"
												...
												<span class="iti__country-name">Папский Престол (Государство-город Ватикан)</span><span
													class="iti__dial-code">+39</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pg"
												role="option" data-dial-code="675" data-country-code="pg">
												<div class="iti__flag-box">
													<div class="iti__flag iti__pg"></div>
												</div>
												<span class="iti__country-name">Папуа Новая Гвинея</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pe"
												...
												<span class="iti__country-name">Перу</span><span class="iti__dial-code">+51</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pr"
												...
												<span class="iti__country-name">Пуэрто-Рико</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-xk"
												role="option" data-dial-code="383" data-country-code="xk">
												<div class="iti__flag-box">
													<div class="iti__flag iti__xk"></div>
												</div>
												<span class="iti__country-name">Республика Косово</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-re"
												...
												<span class="iti__country-name">Реюньон</span><span
													class="iti__dial-code">+262</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ru"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-st"
												role="option" data-dial-code="239" data-country-code="st">
												<div class="iti__flag-box">
													<div class="iti__flag iti__st"></div>
												</div>
												<span class="iti__country-name">Сан-Томе и Принсипи</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sa"
												...
												<span class="iti__country-name">Саудовская Аравия</span><span
													class="iti__dial-code">+966</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-wo"
												role="option" data-dial-code="0" data-country-code="wo">
												<div class="iti__flag-box">
													<div class="iti__flag iti__wo"></div>
												</div>
												<span class="iti__country-name">Свободный ввод</span><span
													class="iti__dial-code">+0</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sh"
												role="option" data-dial-code="290" data-country-code="sh">
												<div class="iti__flag-box">
													<div class="iti__flag iti__sh"></div>
												</div>
												<span class="iti__country-name">Святая Елена, Остров Вознесения, Тристан-да-Кунья</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mk"
												...
												<span class="iti__country-name">Северная Македония</span><span
													class="iti__dial-code">+389</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mp"
												role="option" data-dial-code="1" data-country-code="mp">
												<div class="iti__flag-box">
													<div class="iti__flag iti__mp"></div>
												</div>
												<span class="iti__country-name">Северные Марианские Острова</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sc"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-bl"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sx"
												...
												<span
													class="iti__country-name">Сен-Мартен (нидерландская часть)</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-mf"
												role="option" data-dial-code="590" data-country-code="mf">
												<div class="iti__flag-box">
													<div class="iti__flag iti__mf"></div>
												</div>
												<span
													class="iti__country-name">Сен-Мартен (французская часть)</span><span
													class="iti__dial-code">+590</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-vc"
												...
												<span class="iti__country-name">Сент-Винсент и Гренадины</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-kn"
												role="option" data-dial-code="1" data-country-code="kn">
												<div class="iti__flag-box">
													<div class="iti__flag iti__kn"></div>
												</div>
												<span class="iti__country-name">Сент-Китс и Невис</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-lc"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pm"
												...
												<span class="iti__country-name">Сент-Пьер и Микелон</span><span
													class="iti__dial-code">+508</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-rs"
												role="option" data-dial-code="381" data-country-code="rs">
												<div class="iti__flag-box">
													<div class="iti__flag iti__rs"></div>
												</div>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sy"
												role="option" data-dial-code="963" data-country-code="sy">
												<div class="iti__flag-box">
													<div class="iti__flag iti__sy"></div>
												</div>
												<span
													class="iti__country-name">Сирийская Арабская Республика</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gb"
												...
												<span class="iti__country-name">Соединенное Королевство</span><span
													class="iti__dial-code">+44</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-us"
												...
												<span class="iti__country-name">Соединенные Штаты</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sb"
												role="option" data-dial-code="677" data-country-code="sb">
												<div class="iti__flag-box">
													<div class="iti__flag iti__sb"></div>
												</div>
												<span class="iti__country-name">Соломоновы Острова</span><span
													class="iti__dial-code">+677</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-so"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sd"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sl"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tz"
												...
												<span class="iti__country-name">Танзания, Объединенная Республика</span><span
													class="iti__dial-code">+255</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tl"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tg"
												...
												<span class="iti__country-name">Того</span><span class="iti__dial-code">+228</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tk"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-to"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tt"
												role="option" data-dial-code="1" data-country-code="tt">
												<div class="iti__flag-box">
													<div class="iti__flag iti__tt"></div>
												</div>
												<span class="iti__country-name">Тринидад и Тобаго</span><span
													class="iti__dial-code">+1</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tv"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tn"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-tm"
												role="option" data-dial-code="993" data-country-code="tm">
												<div class="iti__flag-box">
													<div class="iti__flag iti__tm"></div>
												</div>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-uz"
												...
												<span class="iti__country-name">Узбекистан</span><span
													class="iti__dial-code">+998</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ua"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-wf"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-fo"
												...
												<span class="iti__country-name">Фарерские Острова</span><span
													class="iti__dial-code">+298</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-fj"
												...
												<span class="iti__country-name">Фиджи</span><span
													class="iti__dial-code">+679</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-fk"
												...
												<span
													class="iti__country-name">Фолклендские Острова (Мальвинские)</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gf"
												...
												<span class="iti__country-name">Французская Гвиана</span><span
													class="iti__dial-code">+594</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-pf"
												role="option" data-dial-code="689" data-country-code="pf">
												<div class="iti__flag-box">
													<div class="iti__flag iti__pf"></div>
												</div>
												<span class="iti__country-name">Французская Полинезия</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cf"
												role="option" data-dial-code="236" data-country-code="cf">
												<div class="iti__flag-box">
													<div class="iti__flag iti__cf"></div>
												</div>
												<span class="iti__country-name">Центрально-Африканская Республика</span><span
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-td"
												...
												<span class="iti__country-name">Чад</span><span class="iti__dial-code">+235</span>
											</li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-me"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-cl"
												...
												<span class="iti__country-name">Чили</span><span class="iti__dial-code">+56</span>
											</li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sj"
												role="option" data-dial-code="47" data-country-code="sj">
												<div class="iti__flag-box">
													<div class="iti__flag iti__sj"></div>
												</div>
												<span class="iti__country-name">Шпицберген и Ян Майен</span><span
													class="iti__dial-code">+47</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-lk"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ec"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-gq"
												...
												<span class="iti__country-name">Экваториальная Гвинея</span><span
													class="iti__dial-code">+240</span></li>
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ax"
												role="option" data-dial-code="358" data-country-code="ax">
												<div class="iti__flag-box">
													<div class="iti__flag iti__ax"></div>
												</div>
												<span class="iti__country-name">Эландские Острова</span><span
													class="iti__dial-code">+358</span></li>
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-er"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-sz"
											...
											<li class="iti__country iti__standard" tabindex="-1" id="iti-item-ss"
									...
									<input placeholder="+7 ___ ___-__-__" name="ORDER_PROP_3" class="k-input"
										   inputmode="tel" autocomplete="tel" data-intl-tel-input-id="0"
										   style="padding-left: 51px;"></div>
							</div>
							<div class="k-input-wrapper"><input placeholder="E-mail*" name="ORDER_PROP_4"
																class="k-input"></div>
						</div>
						<div class="checkout-left-delivery">
							...
							<div class="checkout-left-delivery-container">
								<div class="checkout-left-delivery-el" index="0"><input name="DELIVERY_ID"
																						id="delivery9" type="radio"
																						class="k-checkbox" value="9">
									<label for="delivery9" class="checkout-left-delivery-el-text">
										<div class="checkout-left-delivery-el-text-title">Почта России</div>
									</label></div>
								<div class="checkout-left-delivery-el" index="1"><input name="DELIVERY_ID"
																						id="delivery5" type="radio"
																						class="k-checkbox" value="5">
									<label for="delivery5" class="checkout-left-delivery-el-text">
										<div class="checkout-left-delivery-el-text-title">Самовывоз</div>
										<div class="checkout-left-delivery-el-text-subtitle"><span class="address__">Россия, Камчатский край, Петропавловск-Камчатский, Советская улица, 48</span>
											<div style="display: none;">
												<section class="ymap-container" id="map_1"
														 style="width: 400px; height: 400px;">
													<div id="yandexMap23948" style="width: 100%; height: 100%;">
															...
															<ymaps
																...
																<ymaps class="ymaps-2-1-79-inner-panes">
																	<ymaps
																		...
																		unselectable="on"
																		style="height: 100%; width: 100%; top: 0px; left: 0px; position: absolute; z-index: 3000; cursor: url(&quot;https://api-maps.yandex.ru/2.1.79/build/release/images/cursor/grab.cur&quot;) 16 16, url(&quot;https://api-maps.yandex.ru/2.1.79/build/release/images/cursor/grab.cur&quot;), move;"></ymaps>
																	...
																	<ymaps class="ymaps-2-1-79-copyrights-pane"
																		...
																		<ymaps
																			...
																			<ymaps>
																				<ymaps class="ymaps-2-1-79-gotoymaps"
																					   title="Как добраться"
																					   style="display: none;">
																					<ymaps
																						class="ymaps-2-1-79-gotoymaps__container">
																						<ymaps
																							class="ymaps-2-1-79-gotoymaps__pin"></ymaps>
																						<ymaps
																				...
																				<ymaps class="ymaps-2-1-79-gototaxi"
																					   title="Доехать на такси"
																					   style="display: none;">
																					<ymaps
																						class="ymaps-2-1-79-gototaxi__container">
																						<ymaps
																							class="ymaps-2-1-79-gototaxi__pin"></ymaps>
																						<ymaps
																							class="ymaps-2-1-79-gototaxi__text-container">
																							<ymaps
																								class="ymaps-2-1-79-gototaxi__text"></ymaps>
																						</ymaps>
																					</ymaps>
																				</ymaps>
																	...
																	<ymaps class="ymaps-2-1-79-controls-pane"
																		...
																		<ymaps class="ymaps-2-1-79-controls__toolbar"
																				...
																				<ymaps
																					...
																					<ymaps>
																						<ymaps
																							...
																							<ymaps
																								class="ymaps-2-1-79-float-button-icon ymaps-2-1-79-float-button-icon_icon_geolocation"></ymaps>
																							<ymaps
																								class="ymaps-2-1-79-float-button-text"></ymaps>
																						</ymaps>
																					</ymaps>
																				</ymaps>
																				<ymaps
																					...
																					<ymaps>
																						<ymaps
																							...
																							<ymaps
																								...
																								<ymaps>
																									<ymaps
																										...
																										title="Найти">
																										<ymaps
																											class="ymaps-2-1-79-float-button-icon ymaps-2-1-79-float-button-icon_icon_magnifier"></ymaps>
																										<ymaps
																							...
																							<ymaps
																								id="id_168719650183891806331"></ymaps>
																						</ymaps>
																					</ymaps>
																				</ymaps>
																			</ymaps>
																							...
																							<ymaps
																								...
																								<ymaps>
																									<ymaps
																										...
																										<ymaps
																											class="ymaps-2-1-79-traffic__icon ymaps-2-1-79-traffic__icon_icon_off ymaps-2-1-79-float-button-icon"></ymaps>
																										<ymaps
																											class="ymaps-2-1-79-float-button-text">
																											<ymaps>
																												Пробки
																							...
																							<ymaps
																								...
																								<ymaps>
																									<ymaps
																										...
																										style="width: 270px;">
																										<ymaps
																											class="ymaps-2-1-79-traffic__tail ymaps-2-1-79-popup__tail"></ymaps>
																										<ymaps
																					...
																					<ymaps>
																						<ymaps
																							...
																							<ymaps
																								...
																								title="">
																								<ymaps
																									class="ymaps-2-1-79-listbox__button-icon ymaps-2-1-79-_icon_layers"></ymaps>
																								<ymaps
																									class="ymaps-2-1-79-listbox__button-text">
																									Слои
																								</ymaps>
																								<ymaps
																									class="ymaps-2-1-79-listbox__button-arrow"></ymaps>
																							</ymaps>
																							<ymaps
																									...
																									<ymaps>
																										<ymaps>
																											<ymaps
																												...
																												<ymaps>
																													<ymaps
																														class="ymaps-2-1-79-listbox__list-separator"></ymaps>
																												</ymaps>
																											</ymaps>
																										</ymaps>
																									</ymaps>
																				...
																				<ymaps
																					...
																					<ymaps>
																						<ymaps
																							...
																							title="">
																							<ymaps
																								class="ymaps-2-1-79-float-button-icon ymaps-2-1-79-float-button-icon_icon_expand"></ymaps>
																							<ymaps
																								class="ymaps-2-1-79-float-button-text"></ymaps>
																						</ymaps>
																					</ymaps>
																		...
																		<ymaps class="ymaps-2-1-79-controls__bottom"
																			   style="top: 0px;">
																			<ymaps
																				...
																				<ymaps>
																					<ymaps style="display: block;">
																								...
																								<ymaps>
																									<ymaps
																										...
																										<ymaps
																											...
																											<ymaps
																												class="ymaps-2-1-79-scaleline__left-border"></ymaps>
																											<ymaps
																												class="ymaps-2-1-79-scaleline__left-line"></ymaps>
																										</ymaps>
																										<ymaps
																										...
																										<ymaps
																											...
																											<ymaps
																												class="ymaps-2-1-79-scaleline__right-border"></ymaps>
																											<ymaps
																												class="ymaps-2-1-79-scaleline__right-line"></ymaps>
																										</ymaps>
																									</ymaps>
																								</ymaps>
																							</ymaps>
																						...
																						<ymaps
																							style="display: inline-block; width: 10px; height: 0"></ymaps>
																						<ymaps
																							...
																							<ymaps
																								...
																								<ymaps>
																									<ymaps
																										...
																										<ymaps
																											class="ymaps-2-1-79-float-button-icon ymaps-2-1-79-float-button-icon_icon_ruler"></ymaps>
																										<ymaps
																											class="ymaps-2-1-79-float-button-text"></ymaps>
																									</ymaps>
																								</ymaps>
																				...
																				<ymaps
																						...
																						<ymaps>
																							<ymaps
																								...
																								<ymaps
																									...
																									<ymaps
																										class="ymaps-2-1-79-searchbox-input__clear-button"></ymaps>
																								</ymaps>
																								<ymaps
																									class="ymaps-2-1-79-searchbox-list-button"></ymaps>
																							</ymaps>
																							<ymaps
																					...
																					<ymaps
																						...
																						<ymaps
																							...
																							<ymaps
																								class="ymaps-2-1-79-searchbox__fold-button-icon"></ymaps>
																						</ymaps>
																					</ymaps>
																				</ymaps>
																				<ymaps id="id_168719650183891806333">
																					<ymaps>
																						<ymaps
																							class="ymaps-2-1-79-islets_serp-popup ymaps-2-1-79-islets__hidden">
																							<ymaps
																								class="ymaps-2-1-79-islets_serp-popup__tail"></ymaps>
																							<ymaps
						...
						<div class="checkout-left-addr">
							<div class="k-input-wrapper location__modal_search_box"><input type="hidden"
																						   name="ORDER_PROP_6"
																						   value="0000073738"> <input
									autocomplete="off" placeholder="undefined*" class="k-input">  <!----></div>
						</div>
						<div class="checkout-left-textarea"><label>Комментарий:</label><textarea
								name="ORDER_DESCRIPTION"></textarea></div>
						<div class="checkout-left-checkbox">
							<div class="reservation-form-r3-r"><input type="hidden" name="ORDER_PROP_20" value="N">
								<input type="checkbox" id="POLITIC" value="Y" name="ORDER_PROP_20" class="k-checkbox">
								<label for="POLITIC" class="reservation-form-r3-r-text"><span>ознакомился с <a
											href="/politika-konfidentsialnosti/" target="_blank"
											class="reservation-form-r3-r-a">политикой                         конфиденциальности</a>и согласен на обработку персональных данных</span>
									<a href="#" class="reservation-form-r3-r-q">
										<svg width="11" height="11" viewBox="0 0 11 11" fill="none"
											 xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" clip-rule="evenodd"
												  d="M5.5 11C8.53757 11 11 8.53757 11 5.5C11 2.46243 8.53757 0 5.5 0C2.46243 0 0 2.46243 0 5.5C0 8.53757 2.46243 11 5.5 11ZM5.0401 6.23241C4.95271 6.43408 4.90902 6.66936 4.90902 6.93825H5.91735C5.91735 6.66263 5.98121 6.43072 6.10893 6.2425C6.24338 6.05427 6.4484 5.8358 6.72402 5.58708C6.93913 5.39213 7.11054 5.22408 7.23827 5.08291C7.36599 4.94175 7.47354 4.76697 7.56093 4.55858C7.65504 4.34347 7.7021 4.09811 7.7021 3.8225C7.7021 3.26455 7.48699 2.82761 7.05677 2.51166C6.62654 2.189 6.04507 2.02766 5.31235 2.02766C4.73424 2.02766 4.22335 2.12513 3.77968 2.32008C3.34274 2.51502 2.9831 2.794 2.70076 3.157L3.43685 3.68133C3.85363 3.15027 4.45527 2.88475 5.24177 2.88475C5.69215 2.88475 6.04507 2.98558 6.30052 3.18725C6.55596 3.38219 6.68368 3.64436 6.68368 3.97375C6.68368 4.21575 6.61982 4.42413 6.4921 4.59891C6.36438 4.76697 6.16607 4.96863 5.89718 5.20391C5.68207 5.39886 5.50729 5.56691 5.37285 5.70808C5.24513 5.84925 5.13421 6.02402 5.0401 6.23241ZM4.94935 9.04566C5.07707 9.16666 5.23504 9.22716 5.42326 9.22716C5.60477 9.22716 5.75602 9.16666 5.87702 9.04566C6.00474 8.91794 6.0686 8.76333 6.0686 8.58183C6.0686 8.40033 6.0081 8.24908 5.8871 8.12808C5.7661 8.00036 5.61149 7.9365 5.42326 7.9365C5.23504 7.9365 5.07707 8.00036 4.94935 8.12808C4.82835 8.24908 4.76785 8.40033 4.76785 8.58183C4.76785 8.76333 4.82835 8.91794 4.94935 9.04566Z"
												  fill="#BABECA"></path>
										</svg>
									</a> <!----> </label></div>
							<div class="reservation-form-r3-r"><input type="hidden" name="ORDER_PROP_14" value="N">
								<input type="checkbox" id="OFFERTA" value="Y" name="ORDER_PROP_14" class="k-checkbox">
								<label for="OFFERTA" class="reservation-form-r3-r-text"><span>согласен с <a
											class="reservation-form-r3-r-a" target="_blank" href="/oferta/">договором-офертой</a></span>
									<a href="#" class="reservation-form-r3-r-q">
										<svg width="11" height="11" viewBox="0 0 11 11" fill="none"
											 xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" clip-rule="evenodd"
						...
						<div class="bluebutton-wrapper">
							<button class="bluebutton">ВНЕСТИ ОПЛАТУ</button> <!----></div> <!----></div>
					<div class="checkout-right">
						<div>
							<div class="checkout-right-title">Информация о заказе</div>
							<div class="checkout-right-price">
								<div class="checkout-right-price-text">Стоимость: <span>3&nbsp;000 р.</span></div>
							</div>
							<div class="checkout-right-price">
							...
							<div class="checkout-right-price">
								<div class="checkout-right-price-text">Списать бонусы: <span>0 р.</span></div>
							</div> <!---->
							...
							<button class="bluebutton">ВНЕСТИ ОПЛАТУ</button> <!----> <!----></div>
					</div>
					<section class="pay" style="display: none;">
						<div class="pay__item" index="0"><input type="radio" id="pay5" name="PAY_SYSTEM_ID" value="5">
							<label for="pay5">Сбербанк</label></div>
					</section>
				</div>
			</div>
		</div>
